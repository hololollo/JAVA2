...
class Outer3 { // 외부 클래스
	...
	Runnable getRunnable(int i) { // Runnable은 인터페이스 이므로 인스턴스 생성시 기본 메서드인 run() 메서드의 구현내용을 기술하여 생성해야 함.
		int num = 100; // 지역 변수
...
public class AnonymousInnerExam {
	...
	public static void main(String[] args) {
		...
		Runnable runAble = out.getRunnable(500); // => 외부 클래스의 내부 클래스 없이 생성된 인스턴스
		runAble.run();
	}
